          ...
          <ul className="accordion_box clearfix">
            <li className="accordion block active-block">
              <div className="acc-btn">
                <span>QA: 01</span> Type your questions about your projects of
                ICO?
              </div>
            ...
            <li className="accordion block">
              <div className="acc-btn ">
                <span>QA: 02</span> Type your questions about your projects of
                ICO?
              </div>
            ...
            <li className="accordion block">
              <div className="acc-btn">
                <span>QA: 03</span> Type your questions about your projects of
                ICO?
              </div>
              <div className="acc_body ">
                <div className="content">
            ...
            <li className="accordion block">
              <div className="acc-btn">
                <span>QA: 04</span> Type your questions about your projects of
                ICO?
              </div>
              <div className="acc_body">
                <div className="content">
